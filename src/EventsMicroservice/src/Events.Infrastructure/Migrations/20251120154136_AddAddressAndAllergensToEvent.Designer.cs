...
namespace Events.Infrastructure.Migrations
{
    ...
    [Migration("20251120154136_AddAddressAndAllergensToEvent")]
    partial class AddAddressAndAllergensToEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Events.Domain.Entities.Event", b =>
                {
                    b.OwnsOne("Events.Domain.Entities.EventAddress", "EventAddress", b1 =>
                        {
                    ...
                    b.OwnsMany("Events.Domain.Entities.EventFoodDetails", "EventFoodDetails", b1 =>
                        {
                            b1.Property<Guid>("EventId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<string>("AdditionalFoodItems")
                                .HasMaxLength(1000)
                                .HasColumnType("character varying(1000)");

                            b1.PrimitiveCollection<List<string>>("Allergens")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.PrimitiveCollection<List<string>>("DietaryStyles")
                                .IsRequired()
                                .HasColumnType("text[]");
