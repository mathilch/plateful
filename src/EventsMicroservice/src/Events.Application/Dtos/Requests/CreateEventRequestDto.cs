...
/// <summary>
/// Defines the contract for creating a new event with scheduling, audience and media information.
/// </summary>
/// <param name="Name">Human friendly title shown to attendees and in listings.</param>
/// <param name="Description">Detailed explanation of what the event offers.</param>
...
/// <param name="ImageThumbnail">Cover image shown in event previews.</param>
...
/// <param name="StreetAddress">Primary address line where the event takes place.</param>
/// <param name="PostalCode">Postal or ZIP code for the venue.</param>
/// <param name="City">City in which the event is hosted.</param>
/// <param name="Region">State, province or broader region for the address.</param>
